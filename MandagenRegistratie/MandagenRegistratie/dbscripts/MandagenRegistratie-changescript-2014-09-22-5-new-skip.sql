...
@column_name + ' ' + @data_type + '(MAX) COLLATE ' + @collate
END
ELSE
BEGIN
SET @sql = 'ALTER TABLE ' + @table + ' ALTER COLUMN ' + 
@column_name + ' ' + @data_type + '(' + CAST(@max_length AS 
nvarchar(100)) + ') COLLATE ' + @collate
END
PRINT @sql
EXEC sp_executesql @sql
END TRY
BEGIN CATCH
PRINT 'ERROR: Some index or contraint rely on the column' + 
